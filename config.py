...
ADJUSTED_OUTPUT_CSV           = f"{_r_data}/adjusted_output.csv"
ADJUSTED_COMMODITY_OUTPUT_CSV = f"{_r_data}/adjusted_commodity_output.csv"
...
def apply_version(ver):
    ...
    m.ADJUSTED_OUTPUT_CSV           = f"{_r}/adjusted_output.csv"
    m.ADJUSTED_COMMODITY_OUTPUT_CSV = f"{_r}/adjusted_commodity_output.csv"
